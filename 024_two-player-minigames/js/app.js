(() => {
  ...
  const elements = {
    menuScreen: byId("menuScreen"), gameScreen: byId("gameScreen"), sumoCard: byId("sumoCard"), tugCard: byId("tugCard"), bombCard: byId("bombCard"), boxingCard: byId("boxingCard"), canvas: byId("gameCanvas"),
