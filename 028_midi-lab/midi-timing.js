/* Tempo/meter map normalization and reusable musical-time conversion. */
(function (global) {
  "use strict";
  ...
  global.MidiTiming = { buildTempoMap, buildTimeSignatureMap, timing, tempoAtTick, signatureAtTick, tickToSeconds, secondsToTick, tickToBarBeat, barBeatToTick, ticksPerBeat, ticksPerBar, totalBars };
})(window);
