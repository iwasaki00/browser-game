...
if (!html.includes("2026.08.30-4")) throw new Error("Visible app version is missing");
...
console.log(`Startup status passed: visible version 2026.08.30-4 and ${assets.length} cache-busted assets.`);
