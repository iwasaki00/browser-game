...
if (!html.includes("2026.08.30-8")) throw new Error("Visible app version is missing");
...
for (const status of ["保存領域に接続中", "保存データを読み込み中", "録音音声を読み込み中", "起動完了・操作できます", "起動完了・音声有効"]) {
...
console.log(`Startup status passed: visible version 2026.08.30-8 and ${assets.length} cache-busted assets.`);
