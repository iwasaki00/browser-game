...
if (!html.includes("2026.09.05-1")) throw new Error("Visible app version is missing");
...
console.log(`Startup status passed: visible version 2026.09.05-1 and ${assets.length} cache-busted assets.`);
